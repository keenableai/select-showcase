...
.intro{max-width:880px;margin:0 0 36px;font-size:17px;color:#333}
h2.section{font-weight:400;font-size:34px;line-height:.95;margin:0 0 22px}
.doc{margin:64px 0 0}
.doc p{max-width:880px;margin:0 0 14px;color:#333}
.doc h3{font-weight:400;font-size:22px;margin:28px 0 12px}
.doc ul{max-width:880px;margin:0 0 14px 22px}
